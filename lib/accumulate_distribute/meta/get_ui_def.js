  ...
  fields: {
    ...
    catchUp: {
      ...
      customHelp: t(
        i18n,
        'catchUpHelp',
        'If the algo falls behind in filling orders, disregard the slice interval and submit the next order after a 2 second delay'
      )
    },
    ...
    awaitFill: {
      ...
      customHelp: t(
        i18n,
        'awaitFillHelp',
        "Keeps the current order open until it fills, while tracking progress for 'Catch up'"
      )
    },
    ...
    amount: {
      ...
      customHelp: t(
        i18n,
        'amountHelp',
        'Total order amount, to be executed slice-by-slice'
      ),
    ...
    sliceIntervalSec: {
      ...
      customHelp: t(
        ...
        'Time to wait between each slice order, in seconds'
      )
    },
    ...
    intervalDistortion: {
      ...
      customHelp: t(
        i18n,
        'intervalDistortionHelp',
        'Amount to distort each slice interval, in percent'
      )
    },
    ...
    offsetType: {
      ...
      customHelp: t(
        i18n,
        'offsetTypeHelp',
        'Relative order price as offset from an indicator/book/last trade'
      ),
      options: {
    ...
    offsetDelta: {
      ...
      customHelp: t(
        i18n,
        'offsetDeltaHelp',
        'Price as distance from offset value'
      ),
      default: 0
    },
    ...
    offsetIndicatorPeriodEMA: {
      ...
      customHelp: t(
        i18n,
        'emaPeriodHelp',
        'Period for exponential moving average indicator'
      ),
      visible: {
        offsetType: { eq: 'EMA' }
      }
    ...
    capType: {
      ...
      customHelp: t(
        i18n,
        'priceCapTypeHelp',
        'Upper price limit for relative order type'
      ),
      options: {
        BID: t(i18n, 'topBid', 'Top Bid'),
        ASK: t(i18n, 'topAsk', 'Top Ask'),
    ...
    capIndicatorPeriodSMA: {
      ...
      customHelp: t(
        i18n,
        'smaPeriodHelp',
        'Period for moving average indicator'
      ),
      visible: {
        capType: { eq: 'SMA' }
      }
