 ...
 * @param {number} [args.intervalDistortion=0] - slice interval distortion in %
 * @param {number} [args.amountDistortion=0] - slice amount distortion in %
 * @param {string} args.orderType - LIMIT, MARKET, RELATIVE
 * @param {number} [args.limitPrice] - price for LIMIT orders
 * @param {boolean} args.catchUp - if true, interval will be ignored if behind
 *   with filling slices
 * @param {boolean} args.awaitFill - if true, slice orders will be kept open
 *   until filled
 ...
 * @param {number} [args.relativeOffset.delta] - offset distance from price
 *   reference
 * @param {number[]} [args.relativeOffset.args] - MA or EMA indicator arguments
 *   [period]
 * @param {string} [args.relativeOffset.candlePrice] - 'open', 'high', 'low',
 *   'close' for MA or EMA indicators
 * @param {string} [args.relativeOffset.candleTimeFrame] - '1m', '5m', '1D',
 *   etc, for MA or EMA indicators
 * @param {object} [args.relativeCap] - maximum price reference for RELATIVE
 *   orders
 ...
 * @param {number[]} [args.relativeCap.args] - MA or EMA indicator arguments
 *   [period]
 * @param {string} [args.relativeCap.candlePrice] - 'open', 'high', 'low',
 *   'close' for MA or EMA indicators
 * @param {string} [args.relativeCap.candleTimeFrame] - '1m', '5m', '1D', etc,
 *   for MA or EMA indicators
