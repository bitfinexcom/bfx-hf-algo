...
const confirmOrderSubmit = require('./meta/confirm_order_submit')
...
const AccumulateDistribute = defineAlgoOrder({
  ...
  headersForLogFile: {
    DATA_MANAGED_CANDLES: ['TYPE', 'DATETIME', 'PRICE', 'PRICE_TYPE', 'MA_TYPE', 'MA_VALUE', 'CANDLE_IGNORED'],
    DATA_TRADES: ['ID', 'DATETIME', 'AMOUNT', 'PRICE'],
    OB_PRICE: ['DATETIME', 'TOP_ASK_ORDER_ID', 'TOP_ASK_PRICE', 'TOP_BID_ORDER_ID', 'TOP_BID_PRICE', 'MID_PRICE'],
    OB_FOR_ORDER: ['ID', 'PRICE', 'TOTAL'],
    ORDER_SUBMIT_LOG: [
      'CID', 'ORDER_TYPE', 'ORDER_AMOUNT', 'ORDER_PRICE', 'SUBMITTED ON', 'OB_TOP_ASK_ORDER_ID', 'OB_TOP_ASK_PRICE',
      'OB_TOP_BID_ORDER_ID', 'OB_TOP_BID_PRICE', 'OB_MID_PRICE', 'OFFSET_VALUE', 'CAP_VALUE', 'LAST_TRADE_ID',
      'LAST_TRADED_MTS', 'LAST_TRADED_AMOUNT', 'LAST_TRADED_PRICE'
    ]
  },
