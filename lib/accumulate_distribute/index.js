 ...
 * channel.
 *
 * @module bfx-hf-algo/AccumulateDistribute
 ...
 * @param {number} [intervalDistortion=0] - slice interval distortion in %
 * @param {number} [amountDistortion=0] - slice amount distortion in %
 * @param {string} orderType - LIMIT, MARKET, RELATIVE
 * @param {number} [limitPrice] - price for LIMIT orders
 * @param {boolean} catchUp - if true, interval will be ignored if behind with
 *   filling slices
 * @param {boolean} awaitFill - if true, slice orders will be kept open until
 *   filled
 ...
 * @param {number} [relativeOffset.delta] - offset distance from price
 *   reference
 * @param {number[]} [relativeOffset.args] - MA or EMA indicator arguments
 *   [period]
 * @param {string} [relativeOffset.candlePrice] - 'open', 'high', 'low',
 *   'close' for MA or EMA indicators
 * @param {string} [relativeOffset.candleTimeFrame] - '1m', '5m', '1D', etc,
 ...
 * @param {number[]} [relativeCap.args] - MA or EMA indicator arguments
 *   [period]
 * @param {string} [relativeCap.candlePrice] - 'open', 'high', 'low', 'close'
 *   for MA or EMA indicators
 * @param {string} [relativeCap.candleTimeFrame] - '1m', '5m', '1D', etc, for
 *   MA or EMA indicators
