 ...
 * @param {number} [sliceAmountPerc] - , slice amount as % of total amount
 * @param {boolean} excessAsHidden - whether to submit remainder as a hidden
 *   order
 * @param {string} orderType - LIMIT or MARKET
 * @param {number} [submitDelay=1500] - in ms
 * @param {number} [cancelDelay=5000] - in ms
