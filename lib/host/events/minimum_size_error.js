 ...
 * @param {bfx-api-node-models.Order} order - the order that is below the
 *   minimum size for its sym
 * @param {bfx-api-node-models.Notification} notification - which reported the
 *   error
 */
const onMinimumSizeError = async (aoHost, gid, order, notification) => {
...
module.exports = onMinimumSizeError
