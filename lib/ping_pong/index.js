...
const onMinimumSizeError = require('./events/error_minimum_size')
const onInsufficientBalanceError = require('./events/insufficient_balance')
...
const onBBandSeedComplete = require('./events/self_bband_seed_complete')
...
module.exports = defineAlgoOrder({
  ...
  events: {
    self: {
      bband_seed_complete: onBBandSeedComplete,
    },
    ...
    errors: {
      minimum_size: onMinimumSizeError,
      insufficient_balance: onInsufficientBalanceError
    }
  }
})
