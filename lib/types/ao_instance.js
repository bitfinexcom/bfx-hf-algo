 ...
 * the {@link AsyncEventEmitter} instance used to trigger internal order logic.
 *
 ...
 * @property {object} state.connection - object passed to exchange adapter
 *   for all API interactions. Contents vary based on the adapter in use.
