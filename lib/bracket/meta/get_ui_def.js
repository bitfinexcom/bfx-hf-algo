...
/**
 * Returns the UI layout definition for Bracket, with a field for each parameter.
 *
 ...
 */
const getUIDef = ({ i18n } = {}) => ({
  label: t(i18n, 'bracket.title', 'Bracket Order'),
  id: 'bfx-bracket',
  ...
  sections: [
    ...
    },
    {
      title: '',
      name: 'general',
      rows: [['orderType', 'orderPrice'], ['amount']]
    },
    {
      title: '',
      name: 'action',
    ...
    },
    {
      ...
      rows: [['limitPrice', 'stopPrice'], ['ocoAmount']]
    },
    {
      title: '',
      name: 'lev',
